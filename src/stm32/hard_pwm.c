...
static const struct gpio_pwm_info pwm_regs[] = {
    ...
    {TIM2,  GPIO('A',  5), 1, GPIO_FUNCTION(2)},
    {TIM2,  GPIO('A', 15), 1, GPIO_FUNCTION(2)},
    ...
    {TIM14, GPIO('A',  7), 1, GPIO_FUNCTION(4)},
    {TIM14, GPIO('B',  1), 1, GPIO_FUNCTION(0)},
    ...
    {TIM16, GPIO('A',  6), 1, GPIO_FUNCTION(5)},
    {TIM16, GPIO('B',  8), 1, GPIO_FUNCTION(2)},
    {TIM16, GPIO('A',  7), 1, GPIO_FUNCTION(5)},
    {TIM16, GPIO('B',  9), 1, GPIO_FUNCTION(2)},
